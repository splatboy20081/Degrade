...
public final class Speed extends PositionCheck {
    ...
    public void process(PositionUpdate positionUpdate) {
         ...
         */
        attributeSpeed += MathUtil.getPotionLevel(player, PotionEffectType.SPEED) * 0.2 * attributeSpeed;

        //How minecraft calculates slowness. 0.15 is the effect modifier.
        attributeSpeed += MathUtil.getPotionLevel(player, PotionEffectType.SLOW) * -.15 * attributeSpeed;
        ...
        if (onGround) {
            ...
            //Only do this when the player is sprinting. You don't move forward without sprinting, my guy.
        ...
        this.blockSlipperiness = entityPlayer.world.getType(new BlockPosition(DegradingMath.floor((float) to.getX()),
