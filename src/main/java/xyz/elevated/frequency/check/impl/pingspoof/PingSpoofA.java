...
public final class PingSpoofA extends PacketCheck {
  ...
  public void process(Object object) {
    if (object instanceof WrappedPlayInFlying) {
      ...
      boolean exempt =
          isExempt(ExemptType.LAGGING, ExemptType.TELEPORTING, ExemptType.TPS, ExemptType.CHUNK);

      if (!exempt
          && !joined
          && transactionPing > keepAlivePing
          && Math.abs(transactionPing - keepAlivePing) > 50) fail();
    }
  }
}
