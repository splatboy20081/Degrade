...
public final class TimerA extends PacketCheck {
  ...
  public void process(Object object) {
    ...
    if (flying) {
      ...
      boolean accepted =
          playerData.getConnectionManager().getKeepAliveTime(serverTicks).isPresent();
      ...
      handle:
      {
        ...
        // We're making sure the deviation check processed and the deviation is smaller than the
        // threshold.
