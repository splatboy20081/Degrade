...
public class DegradingMath {
  ...
  /**
   * @implNote This multiplies the argument with 0.017453292519943295 instead of Math.PI / 180.0
   *     which is slower.
   */
  ...
  /**
   * @implNote This divides the argument with 0.017453292519943295 instead of Math.PI / 180.0 which
   *     is slower.
   */
  ...
  public static double toRadiansJava(double rad) {
    return rad * (Math.PI / 180.0);
  }

  public static double toDegreesJava(double deg) {
  ...
  public static double sqrt(double number) {
    double numberIn =
        Double.longBitsToDouble(
            ((Double.doubleToRawLongBits(number) >> 32)
                    + (number > 100000 ? 1072679338 : 1072632448))
                << 31);
    double accurateNumber1X = (numberIn + number / numberIn) * 0.5;
    return (accurateNumber1X + number / accurateNumber1X) * 0.5;
  }
